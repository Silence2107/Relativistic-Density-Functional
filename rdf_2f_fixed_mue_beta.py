...
parser = argparse.ArgumentParser(description='2 flavour RDF with fixed electron chem. pot. in beta equilibrium',
...
required.add_argument('--mu_e', type=float, default=0.0,
                      help='Electron chemical potential in MeV')
...
def main():
    ...
    for mu_b_ef in mu_b_ef_selection:
        ...
        # optimize mu_q, which is trivially related to mu_e
        mu_q = -args.mu_e
        # do not optimize neutrality equation, mu_q = -mu_e is fixed
